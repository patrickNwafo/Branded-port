        ...
        <div className="grid grid-cols-1 lg:grid-cols-[55%_45%] min-h-[calc(100vh-72px)] items-center gap-0">
          ...
          <div className="flex flex-col justify-center py-16 lg:py-0 pr-0 lg:pr-12">
            ...
            <div ref={tagRef} style={{ opacity: 0 }}>
              <SectionTag variant="green">Available for work</SectionTag>
            </div>
            ...
            {/* Subtitle */}
            <div ref={subtitleRef} className="mt-5" style={{ opacity: 0 }}>
              <p
            ...
            >
              {SITE_META.stats.map((stat) => (
                <div key={stat.label} className="flex flex-col">
                  <span
                    className="font-[family-name:var(--font-syne)] font-extrabold text-[var(--text-bright)] text-[28px] leading-none"
                  >
                    {stat.value}
                  </span>
